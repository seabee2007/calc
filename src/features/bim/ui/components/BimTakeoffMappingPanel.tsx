  ...
  return (
    <div className={CARD_CLASS} data-testid="bim-takeoff-mapping">
          ...
          {(['count', 'line', 'area', 'volume', 'manual'] as const).map((type) => {
            ...
            return (
              <button
                ...
                } disabled:cursor-not-allowed disabled:border-slate-200 disabled:bg-slate-100 disabled:text-slate-500 dark:disabled:border-slate-700 dark:disabled:bg-slate-800 dark:disabled:text-slate-500`}
              >
                {type}
              </button>
            );
      ...
      <button
        ...
        className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-cyan-500 to-sky-600 px-4 py-2 text-sm font-semibold text-white shadow-sm shadow-cyan-500/20 transition hover:from-cyan-400 hover:to-sky-500 disabled:cursor-not-allowed disabled:from-slate-100 disabled:to-slate-100 disabled:text-slate-500 disabled:shadow-none disabled:ring-1 disabled:ring-slate-200 dark:from-cyan-400 dark:to-sky-500 dark:text-slate-950 dark:disabled:from-slate-800 dark:disabled:to-slate-800 dark:disabled:text-slate-500 dark:disabled:ring-slate-700"
      >
