/**
 * Database row types for the Seabee activity schema (snake_case, mirrors migration).
 *
 * These are the raw shapes returned from Supabase — never exposed to the UI directly.
 * Domain types are in seabeeActivityTypes.ts; mappers live in seabeeMappers.ts.
 */
