/**
 * Seabee estimate service.
 *
 * High-level operations combining the assembly instantiation layer with
 * the Seabee repository. This is the primary entry point for UI actions.
 *
 * Guardrails:
 ...
 */
import type { ActivityAssemblySpec, AssemblyUserInputs } from '../domain/seabeeAssemblyTypes';
...
} from '../infrastructure/seabeeRepository';
import type { RepositoryResult } from '../infrastructure/estimateDbTypes';
import type { ProjectConstructionActivity, ProjectActivityLineItem } from '../domain/seabeeActivityTypes';
