...
export function buildCmuBuildingEstimatePreview(input: CmuBuildingQuantityInput): DesignEstimatePreviewLine[] {
  ...
  return [
    ...
    },
    {
      ...
      parameterSnapshot: { ...input.wall, result: { blockBreakdown: cmuLayout.counts, moduleFits: cmuLayout.moduleFits } },
      source: 'parametric_design_builder',
      confidence: 'calculated_from_parameters',
      divisionCode: '04',
      divisionName: 'Masonry',
    ...
    },
    {
      ...
      unit: 'CY',
      formula: 'jamb_grout = jamb_grouted_cells * module_cell_core_area * opening_related_height * core_fill_factor * (1 + grout_waste)',
      parameterSnapshot: {
        openingGrout,
        warning: OPENING_GROUT_CONCEPTUAL_WARNING,
      },
    ...
    },
    {
      ...
      description: 'Lintel/bond beam grout at openings',
      quantity: roundQuantity(cubicMetersToCubicYards(openingGrout.lintelGroutVolumeCubicMeters), 2),
      unit: 'CY',
      formula: 'lintel_grout = lintel_length * wall_thickness * lintel_height * core_fill_factor * (1 + grout_waste)',
      parameterSnapshot: {
        openingGrout,
        warning: OPENING_GROUT_CONCEPTUAL_WARNING,
      },
