/**
 * Usage credit pack catalog — keep in sync with supabase/functions/_shared/usageCreditPacks.ts
 */
...
export function creditPackIdForBillingGroup(groupId: string): UsageCreditPackId | null {
  switch (groupId) {
    case 'ai':
      return 'ai_100';
    case 'weather':
