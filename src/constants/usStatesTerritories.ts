export interface StateTerritoryOption {
  value: string;
  label: string;
}

/** US states, DC, and territories — abbreviations stored internally. */
export const US_STATES_TERRITORIES: StateTerritoryOption[] = [
