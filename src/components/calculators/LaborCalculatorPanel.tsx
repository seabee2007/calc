...
import { resolveLaborAreaSqFt } from '../../utils/concreteLaborInputMapper';
...
const LaborCalculatorPanel: React.FC<LaborCalculatorPanelProps> = ({
  ...
  const areaSqFt = resolveLaborAreaSqFt(
    calculation,
    inputs.slabSize,
    volumeYd,
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-4">
          ...
          {areaSqFt > 0 && (
            <p className="sm:col-span-2 text-xs text-gray-500 dark:text-gray-400 -mt-2">
              Effective area: {Math.round(areaSqFt).toLocaleString()} ft²
            </p>
          )}
        </div>
