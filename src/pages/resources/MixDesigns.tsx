...
<<<<<<< HEAD
          <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-lg shadow-lg p-6">
            ...
            <div className="space-y-6">
              <div>
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Portland Cement Types</h3>
...
>>>>>>> 81a2cbd4801da4ed24dd873c85d90e22ceebbd29
              ...
              <div>
<<<<<<< HEAD
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Aggregates</h3>
...
>>>>>>> 81a2cbd4801da4ed24dd873c85d90e22ceebbd29
              ...
              <div>
<<<<<<< HEAD
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Water</h3>
...
>>>>>>> 81a2cbd4801da4ed24dd873c85d90e22ceebbd29
              ...
              <div>
<<<<<<< HEAD
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Admixtures</h3>
                <ul className="list-disc pl-5 space-y-2 text-gray-700 dark:text-gray-300">
=======
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead className="bg-gray-50 dark:bg-gray-700">
                  <tr>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Target Strength</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">w/c Ratio</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Cement (kg)</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Water (kg)</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Fine Agg. (kg)</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Coarse Agg. (kg)</th>
                    <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-300 uppercase tracking-wider">Air Content (%)</th>
                  </tr>
                </thead>
                <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">25 MPa (≈3,600 psi)</td>
                    <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">0.50</td>
                    <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">320</td>
                    <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">160</td>
                    <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">720</td>
                    <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">1,080</td>
                    <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">2.0</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">30 MPa (≈4,350 psi)</td>
                    <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">0.45</td>
                    <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">360</td>
                    <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">162</td>
                    <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">690</td>
                    <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">1,070</td>
                    <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">2.0</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">40 MPa (≈5,800 psi)</td>
                    <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">0.40</td>
                    <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">400</td>
                    <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">160</td>
                    <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">660</td>
                    <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">1,040</td>
                    <td className="px-6 py-4 whitespace-nowrap text-gray-900 dark:text-white">2.0</td>
=======
          <div className="bg-white/90 backdrop-blur-sm rounded-lg shadow-lg p-6">
          ...
          <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-lg shadow-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-blue-50 dark:bg-blue-900/50 p-4 rounded-lg">
                <h3 className="font-medium text-blue-900 dark:text-blue-100 mb-2">Cost Optimization</h3>
...
<<<<<<< HEAD
              <div className="bg-blue-50 dark:bg-blue-900/50 p-4 rounded-lg">
                <h3 className="font-medium text-blue-900 dark:text-blue-100 mb-2">Workability</h3>
                <ul className="list-disc list-inside text-blue-800 dark:text-blue-200 space-y-1">
=======
              <div className="bg-blue-50 p-4 rounded-lg">
...
<<<<<<< HEAD
              <div className="bg-blue-50 dark:bg-blue-900/50 p-4 rounded-lg">
                <h3 className="font-medium text-blue-900 dark:text-blue-100 mb-2">Durability</h3>
                <ul className="list-disc list-inside text-blue-800 dark:text-blue-200 space-y-1">
=======
              <div className="bg-blue-50 p-4 rounded-lg">
